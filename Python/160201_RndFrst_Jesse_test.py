...
myPath = "C:\Users\RYAN\Downloads\Data1B"
#myPath = "C:\Users\RYAN\Dropbox (MIT)\01_Work\MAS\03_Winter 2016\Realtime Simulator\Data\Data3B"
...
xTrain = selectInput[:-20]
xTest = selectInput[-20:]
...
# split the data into training and testing sets
yTrain = selectOutput[:-20]
yTest = selectOutput[-20:]
...
## Use model
#for i in range(1,6):
#    regr = RandomForestClassifier(n_jobs=1, n_estimators=i, max_depth = 10-i)
#
...
regr = RandomForestClassifier(n_jobs=1, n_estimators=5, max_depth = 10)
...
#numpy.savetxt("foo.csv", regr., delimiter=",")
